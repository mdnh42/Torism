                    ...
                    <Navbar.Collapse className="justify-content-end">
...

                        {
                            !user.displayName ?
                                ...
                                :
                                <>
                                    <Nav.Link className="text-white text-decoration-none" as={Link} to="/my-orders">My Orders</Nav.Link>
                                    <Nav.Link className="text-white text-decoration-none" as={Link} to="/all-orders">Manage All Orders</Nav.Link>
                                    <Nav.Link className="text-white text-decoration-none" as={Link} to="/AddNewOffer">Add A New Offer</Nav.Link>
